            ...
            <div class="collunm_form_register">
              <div class="form-row">
                <div class="form-group col-md-4">
                  ...
                  <input type="text" name="first_name" required maxlength="55" class="form-control" id="inputText4" placeholder="Nome">
                  <div class="invalid-feedback">Este campo é obrigatório.</div>
                </div>
                <div class="form-group col-md-8">
                  <label for="inputText4">Sobrenome</label>
                  <input type="text" name="last_name" required maxlength="55" class="form-control" id="inputPassword4" placeholder="Sobrenome">
                  <div class="invalid-feedback">Este campo é obrigatório.</div>
                </div>
              </div>
              <div class="form-row">
                <div class="form-group col-md-7">
                  ...
                  <input type="text" name="cpf" required maxlength="11" class="form-control" id="inputText4" placeholder="CPF">
                  <div class="invalid-feedback">Este campo é obrigatório.</div>
                </div>
                <div class="form-group col-md-5">
                  <label for="inputText4">RG</label>
                  <input type="text" name="rg" required maxlength="14" class="form-control" id="inputPassword4" placeholder="RG">
                  <div class="invalid-feedback">Este campo é obrigatório.</div>
                </div>
              </div>
              <div class="form-row">
                <div class="form-group col-md-9">
                  ...
                  <input type="text" name="address" required maxlength="55" class="form-control" id="inputAddress" placeholder="Nome da Rua">
                  <div class="invalid-feedback">Este campo é obrigatório.</div>
                </div>
                <div class="form-group col-md-3">
                  <label for="inputAddress2">Numero</label>
                  <input type="tel" name="address_number" required maxlength="10" class="form-control" id="inputAddress" placeholder="123...">
                  <div class="invalid-feedback">Este campo é obrigatório.</div>
                </div>
              </div>
              <div class="form-row">
                <div class="form-group col-md-6">
                  ...
                  <input type="text" name="city" required maxlength="55" class="form-control" id="inputCity">
                  <div class="invalid-feedback">Este campo é obrigatório.</div>
                </div>
                <div class="form-group col-md-3">
                ...
                <div class="form-group col-md-3">
                  ...
                  <input type="text" name="cep" required maxlength="8" class="form-control" id="inputCEP">
                  <div class="invalid-feedback">Este campo é obrigatório.</div>
                </div>
              </div>
            </div>
          ...
          <div class="form_register_button">
            ...
            ?>
                <div class="alert alert-danger" role="alert">
                  <h5>Ta tentando me fuder o desgraçado?</h5>
                </div>
              <?php
              }
              if ($_GET['error'] == 1) {
              ?>
                <div class="alert alert-danger" role="alert">
                  <h5>Este email ja foi cadastrado!</h5>
                </div>
            <?php
              }
            }

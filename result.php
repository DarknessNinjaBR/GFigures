   ...
   <div class="body">
        <div class="content">
            ...
            //Filtro para lançamentos
                 if (isset($_GET["filter_launch"])) {
                    if ($_GET['filter_launch']) {
                        $sql = "SELECT * FROM products WHERE launch = '1';";
                ...
                if (isset($_GET["filter_category"])) {
                    if ($_GET['filter_category']) {
                        $sql = "SELECT * FROM products WHERE category_id = $_GET[filter_category];";
                ...
                if (isset($_GET["filter_brand"])) {
                    if ($_GET['filter_brand']) {
                        ...
                        $sql = "SELECT * FROM products WHERE brand_id = $_GET[filter_brand];";
